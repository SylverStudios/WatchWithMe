...
public class PageController {
	 ...
	 * other configuration, resolves to our /webapp/resources/watchwithme.jsp file.
	 *
	 * The method name is irrelevant as far as Spring is concerned.
	 *
	 * @return The String "watchwithme" to tell Spring to serve the watchwithme.jsp file.
	 */
